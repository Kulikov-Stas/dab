...
class om_widget_tweets extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		?>
			...
			<script>om_twitter_latest_posts('<?php echo $instance['username']; ?>',<?php echo $instance['postcount']; ?>,'twitter_update_list_<?php echo $id?>', <?php echo ($instance['retweets'] ? 'true':'false' ) ?>);</script>
