...
$om_portfolio_meta_box=array (
	...
	'imageblock' => array (
		...
		'fields' => array (
			array ( "name" => '',
					"desc" => __('Upload image (if "Image" type selected or image<b>s</b> if "Gallery" type selected) for this portfolio item (images should be at least 920px wide).<br/><b>Don\'t click</b> "Insert into post" or "Insert Gallery" button, just upload images and close the popup.','om_theme'),
