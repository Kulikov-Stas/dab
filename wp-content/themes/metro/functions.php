...
if(!function_exists('om_admin_enqueue_scripts')) {
	function om_admin_enqueue_scripts() {
		
		// deregister latest jQuery - many troubles and register stable for the theme version
		wp_register_script('jqueryFixes', TEMPLATE_DIR_URI.'/js/jquery.fixes.js', array('jquery'));
		wp_enqueue_script('jqueryFixes');
	
  }
	add_action('admin_enqueue_scripts', 'om_admin_enqueue_scripts');
}
